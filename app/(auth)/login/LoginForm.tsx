...
export default function LoginForm() {
  ...
  return (
    <div className='mt-16 sm:mx-auto sm:w-full sm:max-w-[480px]'>
      <div className='bg-lunarship-gray-100 px-6 py-12 shadow sm:rounded-lg sm:px-12'>
        <form className='space-y-6' onSubmit={formSubmitHandler}>
          ...
          <div className='flex items-center justify-between'>
            <div className='flex items-center'>
              ...
              <label
                htmlFor='remember-me'
                className='ml-3 block text-sm leading-6 text-gray-200'
              >
                Remember me
              </label>
            </div>
          ...
          <div className='relative mt-10'>
            <div className='relative'>
              ...
              <div className='relative flex justify-center text-sm font-medium leading-6'>
                <span className='rounded bg-gray-700 px-6 py-0.5 text-gray-200'>
                  Or continue with
                </span>
              </div>
            </div>
